...
"Girar ARRIBA -> cara VERDE",
"Girar ABAJO -> cara AMARILLA",
"Girar DERECHA -> cara AZUL",
"Girar DERECHA -> cara ROJA"
]
...
cv2.namedWindow("Cara")
cv2.namedWindow("Movimiento")

cv2.setMouseCallback("Cara",click)
...
while True:
    ...
    for y in range(3):
        for x in range(3):
            ...
            roi=hsv[py+20:py+40,px+20:px+40]
            ...
            cv2.putText(frame,color_detectado,(px+20,py+40),
